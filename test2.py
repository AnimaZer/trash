...
if __name__ == "__main__":
    ...
    thread1 = Thread(target=process, args=(0,), daemon=True)
    thread2 = Thread(target=process, args=(1,), daemon=True)
    thread3 = Thread(target=process, args=(2), daemon=True)
    thread4 = Thread(target=process, args=('out4.avi', int(length), video_part * 3), daemon=True)
